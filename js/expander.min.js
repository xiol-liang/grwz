! function() {
	function a() {
		...
		this.init = function() {
			$(document).ready(function() {
				...
				a.siv = b, $("div.expander-siv").length || $("body").append(b), $("img[data-expander]").each(function() {
					...
					c.attr("src", c.attr("src") + "?" + (new Date).getTime()), c.load(function() {
						...
						if (c.addClass("expander-container"), b = b.replace(/(['"])?([a-zA-Z0-9_]+)(['"])?:/g, '"$2": '), b = b ?
							JSON.parse(b) : {}, b.animation && c.addClass(b.animation), b.theme || (b.theme = "dark", c.addClass(
								"theme"), c.addClass("dark"), $("div.expander-siv").addClass("dark"), $("div.expander-siv").addClass(
								"theme")), b.speed || (b.speed = "normal"), b.url) {
							var d = $(this).clone();
						...
						}), $(this).data("container", c), c.addClass("anim-" + b.speed), $("body").append(c), $(this).on("click",
							function() {
			...
			a.siv.removeClass(), a.siv.addClass("expander-siv").addClass("theme").addClass(b.data("options").theme), a.siv.addClass(
				"show"), b.addClass("open"), b.css({
				position: "absolute",
				top: $(window).scrollTop() + "px",
				left: "0px",
				width: "100%",
